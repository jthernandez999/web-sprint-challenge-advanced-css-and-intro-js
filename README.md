...
1. How would you describe acessibility on the web to someone new to programming? Accessibility is the practice of making your websites usable by as many people as possible. Whether it be on mobile devices or making it easier to see for people with sight problems. Making it readible audible for blind people.

2. Talk about 3 different things you can do to ensure your website is accessible. 
Making it mobile friendly, adding captions, and adding meaningful sequence. 

3. How would you explain the concept of a variable to someone new to programming?
variables are keywords that hold value that we assign it to . 

4. What is the purpose of using functions in code?
To keep the code DRY, to avoid repeating the same code over and over again. It is one of the building blocks.
